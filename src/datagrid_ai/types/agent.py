...
from .agent_tool_item import AgentToolItem

__all__ = ["Agent", "AgentTool"]

AgentTool: TypeAlias = Union[AgentTools, AgentToolItem]
...
class Agent(BaseModel):
    ...
    agent_model: Optional[Literal["magpie-1", "magpie-1.1", "magpie-1.1-flash"]] = None
    ...
    disabled_agent_tools: Optional[List[AgentTools]] = None
